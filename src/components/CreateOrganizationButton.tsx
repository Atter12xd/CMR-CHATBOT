  ...
  return (
    <div>
      <button
        ...
        disabled={loading}
        className="inline-flex items-center gap-2 px-5 py-2.5 bg-brand-500 text-white text-sm font-semibold rounded-full hover:bg-brand-600 shadow-md shadow-brand-500/20 transition-all duration-150 disabled:opacity-50 disabled:cursor-not-allowed"
      >
        {loading ? (
          <>
