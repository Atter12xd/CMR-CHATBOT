export default function ProductCardSkeleton({ viewMode = 'grid' }: { viewMode?: 'grid' | 'list' }) {
  if (viewMode === 'list') {
    return (
      <div className="rounded-ref border border-app-line bg-ref-card p-4 shadow-sm animate-pulse">
  ...
  return (
    <div className="rounded-ref border border-app-line bg-ref-card overflow-hidden shadow-sm animate-pulse">
