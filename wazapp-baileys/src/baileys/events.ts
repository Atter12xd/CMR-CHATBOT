...
- Cuando el cliente confirme un pedido con: nombre del cliente, dirección o referencia de envío, y lista de productos con cantidades y precios (puedes usar los de la lista de PRODUCTOS), usa la herramienta create_order para registrar el pedido. Luego informa al cliente su código de pedido.`;
